...
namespace GymManagmetBLL.Service.ViewModels.MemberViewModel
{
    internal class HealthRecordViewModel
    {
        ...
        [StringLength(maximumLength: 3, MinimumLength = 3, ErrorMessage = "Blood Type Must Be 3 Char Or Lower!")]
